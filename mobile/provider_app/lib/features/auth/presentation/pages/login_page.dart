            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Đăng nhập Partner', style: Theme.of(context).textTheme.headlineSmall, textAlign: TextAlign.center),
                  ...
                  TextButton(onPressed: () => context.go('/register'), child: const Text('Đăng ký làm đối tác')),
                ],
              ),
            ),
          ),
