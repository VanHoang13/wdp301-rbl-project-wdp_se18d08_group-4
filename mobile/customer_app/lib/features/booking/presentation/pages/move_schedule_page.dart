...
class MoveSchedulePage extends StatefulWidget {
  const MoveSchedulePage({super.key, required this.referenceId});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Chọn ngày chuyển trọ', style: TextStyle(fontWeight: FontWeight.w700, color: c.onSurface)),
      ),
      body: ListView(
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                Text('Nhà xe: ${quote.providerName}', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 15.sp)),
                SizedBox(height: 4.h),
                Text(
          ...
          if (_days.isEmpty)
            Text('Nhà xe chưa mở lịch trong 14 ngày tới', style: TextStyle(color: c.onSurfaceMuted))
          else
            SizedBox(
              height: 88.h,
  ...
  Widget _slotChip(UniMoveColors c, MoveTimeSlot slot) {
    ...
    return ChoiceChip(
      ...
      labelStyle: TextStyle(
        color: !available
            ? c.onSurfaceMuted
            : (selected ? Colors.white : c.onSurface),
