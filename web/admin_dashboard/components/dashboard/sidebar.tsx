...
function buildNavItems(pendingVerifications?: number): NavItem[] {
  return [
    ...
    },
    {
      ...
      icon: Users,
      subItems: [
        { label: "Khách hàng", href: "/users?tab=customers" },
        { label: "Nhà vận chuyển", href: "/users?tab=providers" },
      ],
    },
    {
      label: "Xác minh",
...
export default function Sidebar({ pendingVerifications }: SidebarProps) {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside
        className="hidden md:flex flex-col fixed left-0 top-0 h-screen z-30 transition-all duration-300 ease-in-out border-r"
        style={{
